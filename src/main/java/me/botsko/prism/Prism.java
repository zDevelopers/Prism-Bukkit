		...
		Bukkit.getScheduler().runTaskAsynchronously(instance, () -> {
			...
			if (prismDataSource != null) {
				try {
					...
					log("Database setup and validated.");
			...
			//handoff to thread - this can be slow.
			handOffAsync();
		});
	}

	private void handOffAsync(){
				Bukkit.getScheduler().runTaskAsynchronously(instance, () -> {
					...
					//hand back to main thread for completion.
					Bukkit.getScheduler().runTask(instance, ()-> completeLoad());
				});
	}
